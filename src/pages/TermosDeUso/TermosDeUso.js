...
const TermosDeUso = () => {
  ...
  return (
    <div className={styles.termosDeUsoContainer}>
      ...
      <p>
        Nós respeitamos sua privacidade e protegemos suas informações pessoais. Para saber mais sobre como coletamos, armazenamos e utilizamos seus dados, consulte nossa <a href="/politica-privacidade">Política de Privacidade</a>.
      </p>

      <h2>3. Direitos de Uso</h2>
      <p>
